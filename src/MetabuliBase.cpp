...
std::vector<Command> metabuliCommands = {
        ...
        {"prodigal", prodigal, &localPar.prodigal, COMMAND_DATABASE_CREATION,
                "Generates CDS folder from species sequence library",
                nullptr,
                "Siyoung Choi <remy0502@snu.ac.kr>",
                "<i: DB>",
                CITATION_SPACEPHARER,
                {{"DB with species library", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::directory}}},
